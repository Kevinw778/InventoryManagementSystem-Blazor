    ...
    public class IMSContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProductInventory>().HasData(
                    ...
                    new ProductInventory { ProductId = 1, InventoryId = 3, InventoryQuantity = 2 }, // Bike Wheel
                    new ProductInventory { ProductId = 1, InventoryId = 4, InventoryQuantity = 2 } // Bike Pedal
                );
        }
    }
}